-- =========================================================================
-- Gera os entregáveis automaticamente a partir das entregas do orçamento
--
--  As entregas que você coloca no orçamento (budgets.entregas: título, formato,
--  duração, quantidade) viram entregáveis do projeto na hora que o job é gerado
--  — ninguém redigita. Expande a QUANTIDADE: uma linha "Reels 15s ×5" cria 5
--  entregáveis (1/5, 2/5, …).
--
--  Roda só na criação (a função já retorna cedo se o projeto do orçamento já
--  existe), então não duplica. Projetos criados sem orçamento seguem sem
--  entregável automático (não há entregas de onde puxar).
-- =========================================================================
