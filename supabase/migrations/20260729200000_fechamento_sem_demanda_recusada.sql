-- Demanda recusada aparecia no relatório do cliente.
--
-- A consulta de "demandas do mês" não filtrava status, então um pedido negado
-- entrava na lista que acompanha a fatura. Achado conferindo o fechamento de
-- julho do Sicredi Sul Minas, um dia antes de faturar: "projeto de teste ·
-- teste", recusada, listada entre as 5 demandas do mês.
--
-- O corpo é o mesmo que já estava no ar; muda uma cláusula.
