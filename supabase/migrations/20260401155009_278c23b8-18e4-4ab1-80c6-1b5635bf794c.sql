...
BEGIN
  ...
  LOOP
    INSERT INTO budget_items (
      ...
      delivery_formats, delivery_duration
    ) VALUES (
      v_budget_id,
      ...
      v_item->>'unit_type',
      CASE WHEN v_item->'delivery_formats' IS NOT NULL AND v_item->'delivery_formats' != 'null'::jsonb
        THEN ARRAY(SELECT jsonb_array_elements_text(v_item->'delivery_formats'))
        ELSE '{}'::text[]
      END,
      v_item->>'delivery_duration'
    );
  END LOOP;
