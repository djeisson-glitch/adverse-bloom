-- =========================================================================
-- Com preço final, a comissão sai por dentro
--
-- O Sicredi Região tem 2% de comissão pro Djêisson e 2% pro Robert. Com a
-- tabela de preço fechada ("taxas e impostos já inclusos"), somar esses 4%
-- por cima levaria os R$ 11.310 do mês pra R$ 11.762,40 — o cliente pagando
-- a mais por causa de um rateio interno, contra um acordo que diz R$ 440 pela
-- Pílula.
--
-- Então: com `precos_finais`, a comissão continua sendo CALCULADA e mostrada
-- (é quanto sai do faturamento pros dois), mas não entra no total.
--
-- Nos outros modelos nada muda: lá a comissão é repasse, o cliente paga e a
-- produtora repassa, como na planilha de orçamento.
-- =========================================================================
