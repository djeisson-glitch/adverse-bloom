-- =========================================================================
-- Os campos de custo da diária nasciam travados
--
-- "claude, eu PRECISO poder lançar os valores de custo no fechamento mensal,
--  na diária" — e ele estava certo: os três campos apareciam na tela, mas
-- desabilitados, porque a tela só libera quando sabe em qual saída gravar.
--
-- Eu tinha acrescentado `saida_ids` na VIEW e esquecido de passar adiante no
-- jsonb do fechamento. A tela lia `d.saida_ids`, recebia undefined, e
-- desabilitava o campo — sem erro, sem aviso, só um input morto.
--
-- Lição repetida: conferi a tela por screenshot e vi os campos lá. Ver que o
-- campo existe não é ver que o campo funciona.
-- =========================================================================
