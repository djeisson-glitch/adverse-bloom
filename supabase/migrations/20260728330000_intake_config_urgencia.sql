-- intake_config passa a devolver a regra de urgência do cliente, pra a tela
-- avisar do adicional ANTES de enviar. O corpo é o mesmo que já estava no ar.
...
DECLARE
  ...
  total      int;
BEGIN
  SELECT id, name, intake_ativo, intake_contatos, urgencia_dias, urgencia_percentual INTO c
  ...
  RETURN jsonb_build_object(
    ...
    -- Regra de urgência, pra tela poder avisar ANTES de enviar.
    'urgencia_dias', c.urgencia_dias,
    'urgencia_percentual', c.urgencia_percentual,
