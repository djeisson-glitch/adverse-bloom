-- =========================================================================
-- A função do fechamento repassa as LINHAS de custo adiante
--
-- A view já agrega `custos_itens`; sem isto o jsonb que a tela lê continua
-- sem o campo, e o lançamento por linha abriria sempre vazio no
-- faturamento mensal — o mesmo esquecimento que já aconteceu com
-- `saida_ids`. Partiu da definição vigente do 20260803210000.
-- =========================================================================
