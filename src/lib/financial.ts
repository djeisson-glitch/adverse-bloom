...
export const FIXED_COSTS = [
  "Distribuição de Lucros", "Pró-labore", "INSS sobre Pró-labore - GPS", "IRRF sobre Pró-labore - Darf",
  "Editores - fixo", "Gestão de projetos & Produtor - Fixo", "Colaboradores - fixo",
  "Aluguel", "Softwares operacionais", "Software comercial",
  "Honorários Contábeis", "Financeiro / BPO",
  "Telefonia e Internet", "Tarifas Bancárias", "Tarifas", "Tarifas DOC / TED", "Tarifa de boleto", "Tarifas de Cartões de Crédito",
  "Simples Nacional - DAS",
  "Reformas e manutenções do escritório", "Manutenção escritório", "Manutenção de equipamentos",
];

export const VARIABLE_COSTS = [
  "Editor / Assistente - Variável",
  "Verba de produção", "Atores", "Locutor", "Freela - Operador de câmeras",
  "Comissões de agência", "Outras comissões",
  "Aluguel de carro", "Aluguel de equipamento", "Drone",
  "Combustíveis / Estacionamento", "Alimentação", "Hospedagens", "Passagem aérea", "Transporte Urbano (táxi, Uber)",
  "Marketing e Publicidade", "Treinamentos", "Cursos de edição / direção",
  "Materiais de Escritório", "Copa e Cozinha", "Uniformes", "Brindes para Clientes", "Confraternizações",
  "Despesas com Viagens dos sócios", "Locação", "Correios", "Exames",
  "Despesas a identificar", "Outras taxas administrativas", "Honorários (outros)",
  "Multas de Trânsito", "Ancine", "Aquisição de bens de pequeno valor - cenografia",
];
...
export function calcTicketMedio(recItems: CAItem[], period: PeriodRange, receitaTotal: number): { valor: number; qtde: number } {
